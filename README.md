...
| "画标准地层柱状图" | ✅ GB/T 958 标准模板，见 `borehole_column.bas` |

### 地质柱状图模板 (borehole_column.bas)

按照中国地质大学（武汉）秭归产学研基地 **《常用地层图例花纹和符号》** 标准编写：

| 特性 | 说明 |
|------|------|
| 📐 **多列标准格式** | 界 / 系 / 统 / 组 / 代号 / 柱状图 / 厚度 / 岩性描述 |
| 🎨 **18 种标准花纹** | 砾岩、砂岩、粉砂岩、泥岩、页岩、炭质页岩、石灰岩、白云岩、硅质岩、煤、花岗岩、玄武岩、片岩、片麻岩、大理岩等 |
| 📊 **默认数据** | 秭归地区南华系—奥陶系 14 层典型剖面 |
| 🔧 **数据驱动** | 修改 `GetSection()` 中的数组即可换地区
